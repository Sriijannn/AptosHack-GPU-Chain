  ...
  return (
    <>
      ...
      <div className="home-section">
        ...
        <h1 className="home-title">Decentralized P2P GPU Market</h1>
        ...
        <div className="home-buttons">
          <button className="home-btn">On-demand Pricing</button>
          <button className="home-btn">Interruptible Pricing</button>{" "}
        </div>
        <img
  ...
  return (
    <header className="headerBar fadeIn">
      <div className="headerContent">
        ...
        <div>
          <button className="headerBtn" onClick={() => onAuth("login")}>
            Log in
          </button>
          <button
            className="headerBtn headerBtnPrimary"
      ...
      <div className="heroContent">
        <div className="heroText">
          ...
          <p className="heroSubtitle">
            Access high-performance GPUs at a fraction of the cost. Join our
            community of renters and providers.
          </p>
          <div className="heroActions">
            <button className="heroBtn heroBtnPrimary ripple">
              Rent a GPU
            </button>
...
function FanVisualization() {
  ...
  return (
    <div className="fan-visualization">
  ...
  return (
    <section className="joinUs fadeIn">
      ...
      <p className="joinUsDesc">
        Join thousands of users who are already benefiting from our GPU sharing
        platform. Whether you need powerful computing resources or want to
        monetize your idle GPUs, we've got you covered.
      </p>
    ...
    <section className="faqSection fadeIn">
      ...
      <div className="faqList">
        <div className="faqItem animatedCard">
          <div className="faqQuestion">What is GPU Share?</div>
          <div className="faqAnswer">
            GPU Share is a platform that connects individuals who need access to
            high-performance GPUs with those who have idle GPUs to rent out.
          </div>
        </div>
        <div className="faqItem animatedCard">
          <div className="faqQuestion">How does the rental process work?</div>
          <div className="faqAnswer">
            Simply sign up as a renter, browse available GPUs, and choose the
            one that fits your needs. You'll be able to contact the provider
            directly to arrange the details.
          </div>
        </div>
        <div className="faqItem animatedCard">
          <div className="faqQuestion">Is there a subscription fee?</div>
          <div className="faqAnswer">
            No, we don't charge any subscription fees. You only pay for the GPU
            resources you use.
          </div>
        </div>
        <div className="faqItem animatedCard">
          <div className="faqQuestion">How can I trust the GPU providers?</div>
          <div className="faqAnswer">
            We have a rating and review system in place for renters to provide
            feedback on their experience with GPU providers. It's always good to
            check the ratings and reviews before renting.
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="getStarted fadeIn">
      ...
      <p className="getStartedDesc">
        Experience the future of computing with GPU Share. Whether you're a
        developer, researcher, or just curious, our platform offers the
        resources you need to supercharge your projects.
      </p>
      <button className="getStartedBtn ripple">Sign Up Now</button>
    </section>
  );
}
    ...
    <footer className="footer">
      <div className="footerContent">
        <div className="footerSection">
          <h3>GPU Chain</h3>
          <p>
            Democratizing access to GPU computing power through blockchain
            technology.
          </p>
        </div>
        <div className="footerSection">
    ...
    <>
      ...
      <main className="main">
        ...
        <div className="howItWorksDesc">
          Our platform connects renters with providers, offering a flexible and
          cost-effective solution for accessing powerful GPUs.
        </div>{" "}
        <Features />
        <FanVisualization />
        <JoinUs />
        ...
        <div className="blockchain-section">
          ...
          <div className="blockchain-desc">
            Beautiful blockchain interface for GPU workers and requesters with
            wallet integration and hourly rates.
          </div>
          ...
          <div className="blockchain-options">
            ...
            <div className="blockchain-option">
              ...
              <button
                className="btn requester-btn"
                onClick={onGoToGPURequester}
              >
                💰 Rent GPU Power
              </button>
            </div>
        ...
        <div className="game-gpu-section">
          ...
          <div className="game-gpu-desc">
            Experience next-level gaming by leveraging multiple peer GPUs for
            enhanced graphics rendering and performance.
          </div>
          <div className="game-gpu-features">
            <div className="feature-item">
              <h4>🚀 Real-time Load Balancing</h4>
              <p>
                Automatically distribute rendering tasks across connected peer
                GPUs
              </p>
            </div>
            <div className="feature-item">
              ...
              <p>
                Achieve higher FPS and better graphics quality using distributed
                processing
              </p>
            </div>
            <div className="feature-item">
